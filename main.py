...
# Define the directory containing the .msg files which is a sub-folder of the current working directory called 'messages'
directory = os.path.join(os.getcwd(), 'messages')
csv_file = 'extracted_data.csv'

# Function to extract data based on headings to make each heading it's own column
...
# Open the CSV file for writing and append each line to the CSV file
with open(csv_file, mode='w', newline='', encoding='utf-8') as file:
    ...
    # Loop through all files in the directory and process .msg files
